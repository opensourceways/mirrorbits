...
type Mirror struct {
	...
	NetBandwidth         int64                `protobuf:"varint,32,opt,name=NetBandwidth,proto3" json:"NetBandwidth,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type AddMirrorReply struct {
	...
	NetBandwidth         int64    `protobuf:"varint,7,opt,name=NetBandwidth,proto3" json:"NetBandwidth,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
